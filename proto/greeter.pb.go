...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\x04size\x18\x03 \x01(\x03R\x04size2\xf5\x02\n" +
	"\aGreeter\x124\n" +
	...
	"\tListFiles\x12\x16.proto.FileListRequest\x1a\x17.proto.FileListResponse\"\x00B\x1bZ\x19grpc-sample-minimal/protob\x06proto3"
...
var file_proto_greeter_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	2,  // 2: proto.Greeter.StreamCounter:input_type -> proto.CounterRequest
	4,  // 3: proto.Greeter.Chat:input_type -> proto.ChatMessage
	5,  // 4: proto.Greeter.UploadFile:input_type -> proto.FileChunk
	7,  // 5: proto.Greeter.DownloadFile:input_type -> proto.FileDownloadRequest
	8,  // 6: proto.Greeter.ListFiles:input_type -> proto.FileListRequest
	1,  // 7: proto.Greeter.SayHello:output_type -> proto.HelloReply
	3,  // 8: proto.Greeter.StreamCounter:output_type -> proto.CounterReply
	4,  // 9: proto.Greeter.Chat:output_type -> proto.ChatMessage
	6,  // 10: proto.Greeter.UploadFile:output_type -> proto.FileUploadStatus
	5,  // 11: proto.Greeter.DownloadFile:output_type -> proto.FileChunk
	9,  // 12: proto.Greeter.ListFiles:output_type -> proto.FileListResponse
